                ...
                {title == "Your Guide to Great Movies" ?
                    (
                        <div className="bg-body-tertiary p-5 border mb-5">
                            ...
                            <p className="lead"><span style={ownStyle}>Hi, It's Manikandan Rajendran.</span> Discover Movies you&apos;ll love with personalized suggestions, curated collections, and quick searches - your guide to finding great films</p>
